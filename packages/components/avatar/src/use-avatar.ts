import type {AvatarVariantProps, SlotsToClasses} from "@w/theme";

import {avatar} from "@w/theme";
import {HTMLNextUIProps, PropGetter} from "@w/system";
import {mergeProps} from "@react-aria/utils";
import {useDOMRef} from "@w/react-utils";
import {clsx, safeText, dataAttr} from "@w/shared-utils";
import {ReactRef} from "@w/react-utils";
import {useFocusRing} from "@react-aria/focus";
import {useMemo, useCallback} from "react";
import {useImage} from "@w/use-image";
import {useHover} from "@react-aria/interactions";

import {useAvatarGroupContext} from "./avatar-group-context";

type AvatarSlots = string | number | symbol;
interface Props extends HTMLNextUIProps<"span"> {
  ...
  classNames?: SlotsToClasses<string>;
}
