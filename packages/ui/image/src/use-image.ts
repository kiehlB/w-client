import type {ImageVariantProps, SlotsToClasses, ImageSlots} from "@w/theme";

import {ImgHTMLAttributes, useCallback} from "react";
import {HTMLNextUIProps, mapPropsVariants, PropGetter} from "@w/system";
import {image} from "@w/theme";
import {useDOMRef} from "@w/react-utils";
import {clsx, dataAttr} from "@w/shared-utils";
import {ReactRef} from "@w/react-utils";
import {useImage as useImageBase} from "@w/use-image";
