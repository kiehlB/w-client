...
export const ListCardMain = classed('div', 'flex-1 flex flex-col items-start ml-4');

export const ListCardDivider = classed('div', 'w-px h-full bg-border-subtlest-tertiary');

export const getPostClassNames = (post: Post, ...postClassNames: string[]): string =>
  classNames(
