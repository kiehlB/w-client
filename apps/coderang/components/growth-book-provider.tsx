...
import { useRequestProtocol } from '../hooks/use-request-protocol';
import { Feature } from '../lib/feature-management';
import { useViewSize, ViewSize } from '../hooks/use-view-size';

type GetFeatureValue = <T extends JSONValue>(feature: Feature<T>) => WidenPrimitives<T>;
