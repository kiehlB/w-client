import React, { ComponentType, ReactElement, ReactNode, useContext } from 'react';
import { FeaturesReadyContext } from './growth-book-provider';

export type WrappedComponentType<Props, LayoutProps = unknown> = ComponentType<Props> & {
  getLayout?: (
    page: ReactElement,
    pageProps?: Props,
