...
const feature = {
  ...
  readingStreaks: new Feature('reading_streaks', ReadingStreaksExperiment.Control),
  ...
  experienceLevel: new Feature('experience_level', ExperienceLevelExperiment.Control),
