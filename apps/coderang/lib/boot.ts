...
import { MarketingCta } from '../components/cards/marketing-cta/common';

interface NotificationsBootData {
  unreadNotificationsCount: number;
}

export type PostBootData = Pick<Post, 'id' | 'title'>;
...
export type BootCacheData = Pick<
  Boot,
  'user' | 'alerts' | 'settings' | 'postData' | 'notifications' | 'squads' | 'exp'
> & { lastModifier?: string };
